...
class PingEndpointListItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "date", "dateTime", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "date", "dateTime", ], str]):
