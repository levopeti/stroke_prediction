...
class PredictionItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["prediction", "probability", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["prediction", "probability", "timestamp", ], str]):
