...
class DataItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["limb", "side", "timestamp", "type", "x", "y", "z", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["limb", "side", "timestamp", "type", "x", "y", "z", ], str]):
